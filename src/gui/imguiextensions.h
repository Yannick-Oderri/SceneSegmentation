...
bool Button(const char *label, const ImVec2 &size, bool enabled = true);

// Behaves like a normal ImGui::Checkbox, but with support for being disabled
//
bool Checkbox(const char *label, bool *checked, bool enabled = true);

// Behaves like a normal ImGui::RadioButton, but with support for being disabled
//
bool RadioButton(const char *label, bool active, bool enabled = true);
bool RadioButton(const char *label, int *v, int vButton, bool enabled = true);
...
//
bool SliderInt(const char *label, int *value, int valueMin, int valueMax, const char *format, bool enabled = true);
...
//
void ShowTooltip(const char *msg, bool show = true);
